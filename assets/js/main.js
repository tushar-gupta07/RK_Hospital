...
(function ($) {
  ...
  var swiper = new Swiper(".team-swiper-container-h1", {
    spaceBetween: 30,
    slidesPerView: 2,  // ✅ 2 doctors
    loop: false,  // ✅ NO LOOP - No duplicates
    speed: 1000,
    // autoplay: {
    //   delay: 3000,
    //   disableOnInteraction: false,
    ...
    breakpoints: {
      1500: {
        slidesPerView: 2,  // ✅ Desktop - 2 doctors
      },
      1199: {
        slidesPerView: 2,  // ✅ Laptop - 2 doctors
      },
      991: {
        slidesPerView: 2,  // ✅ Tablet - 2 doctors
      },
      767: {
        slidesPerView: 2,  // ✅ Tablet small - 2 doctors
      },
      575: {
        slidesPerView: 1,  // ✅ Mobile - 1 doctor
      },
      0: {
        slidesPerView: 1,  // ✅ Mobile small - 1 doctor
      }
    },
  });
});
